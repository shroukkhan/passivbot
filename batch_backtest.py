...
async def main():
    ...
    allowed_symbols = ["XRP", "ADA", "SOL", "TRX", "AXS", "LUNA", "SAND", "AVAX", "FTM", "ALGO", "NEAR", "GALA", "ENS", "WAVES", "KNC", "APE", "GMT", "DAR",]
